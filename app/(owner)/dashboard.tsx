...
export default function OwnerDashboard() {
  ...
  return (
    <View style={styles.container}>
      <ScreenHeader title="Business health" subtitle={`${activeCount} active ${activeCount === 1 ? 'job' : 'jobs'}, ${jobs.length} total`} />
      <FlatList
        data={jobs}
        keyExtractor={j => j.id}
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            ...
            <Text style={styles.emptySub}>Create a job from Schedule and it will show up here.</Text>
          </View>
        }
        renderItem={({ item }) => {
